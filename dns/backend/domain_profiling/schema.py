...
CREATE_INDEX_HISTORY_TS_REG_DOMAIN = """
CREATE INDEX IF NOT EXISTS idx_query_history_ts_reg_domain 
ON domain_query_history (timestamp, registered_domain);
"""

CREATE_INDEX_HISTORY_TS_CLIENT = """
CREATE INDEX IF NOT EXISTS idx_query_history_ts_client 
