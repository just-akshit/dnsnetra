...
class DatabaseConfig:
    ...
    host: str = field(
        default_factory=lambda: os.getenv('DAILY_REVIEW_DB_HOST', os.getenv('UDR_DB_HOST', os.getenv('DB_HOST', 'localhost')))
    )
    port: int = field(
        default_factory=lambda: int(os.getenv('DAILY_REVIEW_DB_PORT', os.getenv('UDR_DB_PORT', os.getenv('DB_PORT', '5432'))))
    )
    database: str = field(
        default_factory=lambda: os.getenv('DAILY_REVIEW_DB_DATABASE', os.getenv('UDR_DB_DATABASE', 'daily_review_db'))
    )
    username: str = field(
        default_factory=lambda: os.getenv('DAILY_REVIEW_DB_USERNAME', os.getenv('UDR_DB_USERNAME', os.getenv('DB_USER', 'postgres')))
    )
    password: str = field(
        default_factory=lambda: os.getenv('DAILY_REVIEW_DB_PASSWORD', os.getenv('UDR_DB_PASSWORD', os.getenv('DB_PASSWORD', '')))
    )
